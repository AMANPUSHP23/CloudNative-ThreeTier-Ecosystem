# CloudNative-ThreeTier-Ecosystem Terraform Infrastructure

This Terraform configuration provisions the enterprise AWS foundation for CloudNative-ThreeTier-Ecosystem, including a custom VPC, EKS cluster, and a secure Bastion entry point.
