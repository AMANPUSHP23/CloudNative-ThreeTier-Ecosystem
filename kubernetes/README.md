# Kubernetes Manifests - CloudNative-ThreeTier-Ecosystem

This directory contains Kubernetes manifests for deploying the CloudNative-ThreeTier-Ecosystem, including ingress-nginx and cert-manager configurations.
...
1. Create a CNAME record for your domain (e.g., `shop.example.com`)
...
| Type  | Name     | Value                                      | TTL  |
|-------|----------|-------------------------------------------|------|
| CNAME | shop     | a1b2c3d4e5f6g7.us-east-1.elb.amazonaws.com | 300  |
